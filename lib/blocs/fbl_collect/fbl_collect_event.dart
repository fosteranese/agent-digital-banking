...
class RetrievePaymentCategoriesWithEndpoint extends PaymentsEvent {
  const RetrievePaymentCategoriesWithEndpoint({required this.routeName, required this.endpoint});
  final String routeName;
  final String endpoint;

  @override
  List<Object> get props => [routeName, endpoint];
}
