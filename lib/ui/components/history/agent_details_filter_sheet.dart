...
class AgentDetailsFilterSheet extends StatefulWidget {
  ...
  @override
  State<AgentDetailsFilterSheet> createState() => _AgentDetailsFilterSheetState();
}

class _AgentDetailsFilterSheetState extends State<AgentDetailsFilterSheet> {
  @override
