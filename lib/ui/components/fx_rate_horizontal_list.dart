...
import 'package:agent_digital_banking/ui/components/slider.dart';
...
class FXRateHorizontalList extends StatefulWidget {
  ...
  @override
  State<FXRateHorizontalList> createState() =>
      _FXRateHorizontalListState();
}

class _FXRateHorizontalListState
    extends State<FXRateHorizontalList> {
  List<Sources> _list = [];
    ...
    context.read<GeneralFlowBloc>().add(
      GeneralFlowEnquiry(
        ...
        form: GeneralFlowForm(
          formId: '111d37ed-95b3-426b-9c2f-13d585fd4dd6',
          categoryId:
              '0fdc593e-89f2-4950-a491-75c66749bbcc',
          accessType: 'CUSTOMER',
          formName: 'Current FX Rates',
          description: '',
          caption: 'Daily FX Rates',
          tooltip: 'Daily FX Rates',
          icon: 'fxrate.png',
          iconType: 'png',
          requireVerification: 0,
          verifyEndpoint: 'DynamicEnquiry/FXRates',
          processEndpoint: 'FBLOnline/Initiate',
          rank: 2,
          status: 1,
          statusLabel: 'Success',
          dateCreated: DateTime.parse(
            '2023-08-12 09:55:26.480',
          ),
          createdBy: 'abowoso',
          dateModified: DateTime.parse(
            '2023-07-13 11:24:03.887',
          ),
          modifiedBy: '',
          internalEndpoint: 'DynamicEnquiry/FXRates',
    ...
    return BlocConsumer<GeneralFlowBloc, GeneralFlowState>(
      listener: (context, state) {
        ...
        ServiceUtil.generalFlowListener(
          context: context,
          state: state,
          routeName: 'fx-rate-horizontal-scroll',
