...
class RequestsSearchBox extends StatefulWidget {
  ...
  @override
  State<RequestsSearchBox> createState() => _RequestsSearchBoxState();
}

class _RequestsSearchBoxState extends State<RequestsSearchBox> {
  ...
  Widget build(BuildContext context) {
    return PreferredSize(
      ...
      child: Container(
        color: Colors.white,
        padding: const .only(top: 20, left: 20, right: 20, bottom: 20),
        child: Column(
          children: [
            Expanded(
              child: Row(
