...
class ProcessFormController {
  ...
  void submit({String? scheduleType, String? scheduleDate}) {
    final payload = FormMultipleInputPlus.getFormData(
      controllers: controllers,
      preGeneralFieldDatum: formData.fieldsDatum,
    );
    ...
    AuthenticationUtil.start(
      ...
      payload: payload,
      onResendShortCode: () =>
          context.read<OtpBloc>().add(ResendOtp(uid: id, formId: formData.form!.formId!)),
      complete:
          ({
            String? otp,
