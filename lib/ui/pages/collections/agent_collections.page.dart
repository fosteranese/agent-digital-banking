...
class AgentCollectionsPage extends StatefulWidget {
  const AgentCollectionsPage({super.key, this.showBackBtn = false});
  final bool showBackBtn;

  @override
  State<AgentCollectionsPage> createState() => _AgentCollectionsPageState();
}

class _AgentCollectionsPageState extends State<AgentCollectionsPage> {
