...
class Agent extends Equatable {
  ...
  factory Agent.fromMap(Map<String, dynamic> data) => Agent(
    ...
    deviceInfo: data['deviceInfo'] as dynamic,
  ...
  /// `dart:convert`
  ///
  /// Parses the string and returns the resulting Json object as [Agent].
  factory Agent.fromJson(String data) {
    return Agent.fromMap(json.decode(data) as Map<String, dynamic>);
  }

  /// `dart:convert`
  ///
  /// Converts [Agent] to a JSON string.
