...
class ChangeSecretAnswerRequest extends Equatable {
  ...
  const ChangeSecretAnswerRequest({this.secretAnswer, this.newSecretAnswer});
  ...
  factory ChangeSecretAnswerRequest.fromJson(String data) {
    return ChangeSecretAnswerRequest.fromMap(json.decode(data) as Map<String, dynamic>);
  }
  ...
  ChangeSecretAnswerRequest copyWith({String? secretAnswer, String? newSecretAnswer}) {
    return ChangeSecretAnswerRequest(
  ...
  List<Object?> get props {
    return [secretAnswer, newSecretAnswer];
  }
}
