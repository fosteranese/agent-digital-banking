...
class AgentCollectionModel extends Equatable {
  ...
  factory AgentCollectionModel.fromMap(Map<String, dynamic> data) {
  ...
  /// `dart:convert`
  ///
  /// Parses the string and returns the resulting Json object as [AgentCollectionModel].
  factory AgentCollectionModel.fromJson(String data) {
    return AgentCollectionModel.fromMap(json.decode(data) as Map<String, dynamic>);
  }

  /// `dart:convert`
  ///
  /// Converts [AgentCollectionModel] to a JSON string.
