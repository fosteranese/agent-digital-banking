...
class ForgotPasswordResponse extends Equatable {
  ...
  const ForgotPasswordResponse({this.otpData, this.ghCardUrl, this.registrationId});
  ...
  ForgotPasswordResponse copyWith({OtpData? otpData, String? ghCardUrl, dynamic registrationId}) {
    return ForgotPasswordResponse(
