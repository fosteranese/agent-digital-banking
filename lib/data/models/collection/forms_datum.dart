...
class FormsDatum extends Equatable {
  ...
  const FormsDatum({this.fieldsData, this.form, this.phoneNumber, this.authMode});

  factory FormsDatum.fromMap(Map<String, dynamic> data) => FormsDatum(
    fieldsData: data['fields'] != null
        ? (data['fields'] as List<dynamic>?)
              ?.map((e) => FieldsDatum.fromMap(e as Map<String, dynamic>))
              .toList()
        : [],
    ...
    authMode: data['authMode'] != null
        ? (data['authMode'] as List<dynamic>?)?.map((e) => e as Map<String, dynamic>).toList()
        : [],
  );
  ...
  FormsDatum copyWith({List<FieldsDatum>? fieldsData, Form? form}) {
    return FormsDatum(fieldsData: fieldsData ?? this.fieldsData, form: form ?? this.form);
  }
  ...
  @override
  List<Object?> get props => [fieldsData, form];
}
